...
import { LoginButton } from "../Header/Header.jsx";
            ...
            <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
                ...
                <form className="flex flex-col">
                    ...
                    <div className="flex items-center justify-between flex-wrap">
                        ...
                        <p className="text-gray-900 mt-4"> Don't have an account? <a href="#" className="text-sm text-blue-500 -200 hover:underline mt-4" onClick={handleSignUpClick}>Signup</a></p>
                    </div>
...
export const SignUpButtonCard = () => {
    return (
        <button type="submit"
                className="bg-gradient-to-r from-indigo-500 to-blue-500 text-white font-bold py-2 px-4 rounded-md mt-4 hover:bg-indigo-600 hover:to-blue-600 transition ease-in-out duration-150">SignUp</button>
    );
}